...
SERVER_STARTUP_SCRIPT="/mnt/cxzx/share/xiaojunqian/scripts/multi_server0167.sh"
...
while true; do
    ...
    echo "GPU配置: Group1[0,1]@8112, Group2[6,7]@8113"
    ...
    for attempt in {1..120}; do
        # 检查两个端口是否都在监听
        if nc -z localhost 8112 && nc -z localhost 8113; then
