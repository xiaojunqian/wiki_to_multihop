...
# 最终汇总文件路径
FINAL_QA_FILE="${BASE_DATA_PATH}/GLOBAL_1228_unique_${NUM_HOPS}hops_questions.jsonl"
FINAL_REF_FILE="${BASE_DATA_PATH}/GLOBAL_1228_unique_${NUM_HOPS}hops_references.jsonl"
FINAL_INV_FILE="${BASE_DATA_PATH}/GLOBAL_1228_unique_${NUM_HOPS}hops_invalid.jsonl"

# vLLM 启动脚本路径
SERVER_SCRIPT="/mnt/cxzx/share/xiaojunqian/scripts/multi_server67.sh"
SERVER_SCRIPT_PID=""
